defmodule Softaliza.EventsTest do
  ...
  describe "articles" do
    ...
    @valid_attrs %{active: true, authors: "some authors", doi: "some doi", publication_date: ~D[2010-04-17], published_by: "some published_by", title: "some title"}
    @update_attrs %{active: false, authors: "some updated authors", doi: "some updated doi", publication_date: ~D[2011-05-18], published_by: "some updated published_by", title: "some updated title"}
    @invalid_attrs %{active: nil, authors: nil, doi: nil, publication_date: nil, published_by: nil, title: nil}
